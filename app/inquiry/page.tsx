  ...
  return (
     ...
     <div className="isolate bg-gray-800 px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-semibold tracking-tight text-balance text-white sm:text-5xl">Inquiry</h2>
        <p className="mt-2 text-lg/8 text-gray-400">Enter your details below and we'll get back to you within 24 hours.</p>
      </div>
